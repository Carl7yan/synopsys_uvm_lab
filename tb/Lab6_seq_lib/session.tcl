...
# DVE full session
# Saved on Thu Oct 27 16:11:59 2022
# Designs open: 1
#   V1: /home/icer/Desktop/projects/ces_uvm-1.1_2011.12/ces_uvm-1.1_2011.12/solutions/Lab6/vcdplus.vpd
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: router_test_top
#   Group count = 1
#   Group sigs signal count = 9
...
#<Session mode="Full" path="session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{69 166} {1272 1033}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 140} {height 462} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 206} {height 462} {dock_state left} {dock_on_new_line true} {child_data_colvariable 147} {child_data_colvalue 70} {child_data_coltype 87} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Transaction.1 [gui_create_window -type Transaction -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 201]
gui_set_window_pref_key -window ${Transaction.1} -key dock_width -value_type integer -value -1
gui_set_window_pref_key -window ${Transaction.1} -key dock_height -value_type integer -value 201
gui_set_window_pref_key -window ${Transaction.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Transaction.1} {{left 0} {top 0} {width 1203} {height 200} {dock_state bottom} {dock_on_new_line true} {child_transaction_col_expand 16} {child_transaction_col_time 80} {child_transaction_col_message 59} {child_transaction_col_caller 65} {child_transaction_col_name 40} {child_transaction_col_scope 86} {child_transaction_col_severity 54} {child_transaction_col_type 36} {child_transaction_col_relation 53} {child_transaction_col_target 43}}
...
if { ![gui_is_db_opened -db {/home/icer/Desktop/projects/ces_uvm-1.1_2011.12/ces_uvm-1.1_2011.12/solutions/Lab6/vcdplus.vpd}] } {
	gui_open_db -design V1 -file /home/icer/Desktop/projects/ces_uvm-1.1_2011.12/ces_uvm-1.1_2011.12/solutions/Lab6/vcdplus.vpd -nosource
...
gui_load_child_values {router_test_top.sigs}


set _session_group_1 sigs
gui_sg_create "$_session_group_1"
set sigs "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { router_test_top.sigs.clk router_test_top.sigs.reset_n router_test_top.sigs.frame_n router_test_top.sigs.valid_n router_test_top.sigs.din router_test_top.sigs.dout router_test_top.sigs.busy_n router_test_top.sigs.valido_n router_test_top.sigs.frameo_n }
...
catch {gui_list_select -id ${Hier.1} {router_test_top.sigs}}
...
gui_list_show_data -id ${Data.1} {router_test_top.sigs}
...
gui_open_source -id ${Source.1}  -replace -active router_test_top /home/icer/Desktop/projects/ces_uvm-1.1_2011.12/ces_uvm-1.1_2011.12/solutions/Lab6/../../rtl/router_test_top.sv
